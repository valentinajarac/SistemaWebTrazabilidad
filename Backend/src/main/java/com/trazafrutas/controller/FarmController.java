...
public class FarmController {
    ...
    public ResponseEntity<?> getMyFarms(@AuthenticationPrincipal User user) {
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse(true, "Fincas obtenidas exitosamente", farms));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getFarmById(@PathVariable Long id, @AuthenticationPrincipal User user) {
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse(true, "Finca encontrada", farm));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
    ...
    public ResponseEntity<?> createFarm(@RequestBody Farm farm, @AuthenticationPrincipal User user) {
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse(true, "Finca creada exitosamente", createdFarm));
    ...
    public ResponseEntity<?> updateFarm(
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse(true, "Finca actualizada exitosamente", updatedFarm));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest()
                    .body(new ApiResponse(false, e.getMessage()));
        } catch (Exception e) {
